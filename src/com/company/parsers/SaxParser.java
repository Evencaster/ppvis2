...
public class SaxParser {
    ...
    private static List<Model> Clients = new ArrayList<>();
        ...
        try {
            ...
            DefaultHandler handler = new DefaultHandler() {
                ...
                public void startElement(String uri, String localName, String queryName, Attributes attributes) throws SAXException {
                    if (queryName.equalsIgnoreCase(ValidFields.FullName.toString())) {
                        bFullName = true;
                    }
                    if (queryName.equalsIgnoreCase(ValidFields.accountNumber.toString())) {
                        bAccountNumber = true;
                    }
                    if (queryName.equalsIgnoreCase(ValidFields.registrationAddress.toString())) {
                        bRegistrationAddress = true;
                    }
                    if (queryName.equalsIgnoreCase(ValidFields.mobileNumber.toString())) {
                        bMobileNumber = true;
                    }
                    if (queryName.equalsIgnoreCase(ValidFields.landLineNumber.toString())) {
    ...
    public static List<Model> getClients() {
        return Clients;
    }
